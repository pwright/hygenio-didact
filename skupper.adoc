...
include::fragments.adoc[tag=check-kubectl]
...
include::fragments.adoc[tag=skupper-version]
...
include::fragments.adoc[tag=kubeconfig-west]
...
include::fragments.adoc[tag=kubeconfig-east]
...
include::fragments.adoc[tag=namespace-west]
...
include::fragments.adoc[tag=namespace-east]
...
include::fragments.adoc[tag=status-west]
...
include::fragments.adoc[tag=status-east]
...
include::fragments.adoc[tag=init-west]
...
include::fragments.adoc[tag=init-east]
...
include::fragments.adoc[tag=token-west]
...
include::fragments.adoc[tag=token-east]
...
include::fragments.adoc[tag=deploy-west]
...
include::fragments.adoc[tag=deploy-east]
...
include::fragments.adoc[tag=expose-east]
...
include::fragments.adoc[tag=expose-west]
