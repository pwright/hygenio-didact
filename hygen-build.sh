...
hygen markdown command --termname hygen --file hygen --location 'builds a new generator for you' --name New-generator --cmd hygen%20generator%20new%20generatorName
